            ...
            <div>
                ...
                <form className="mt-16 text-center" onSubmit={handleSubmitReg}>
                    <div className="mt-2 grid grid-cols-2">
                        ...
                        <input className="border-2 rounded px-2 w-1/2 border-gray-500 mr-4 flex justify-start" type="text" name="name" />
                    </div>
                    <div className="mt-2 grid grid-cols-2">
                    ...
                    <p className='text-red-500 font-semibold'>{error.length>6 ? error : error1?.message}</p>
